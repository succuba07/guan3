...
Font_args = arg_parse()
Font_args.demo = True
Font_args.ckpt_dir = 'FontDiffuser/outputs/FontDiffuser/global_step_4000'
...
def run_fontdiffuer(source_image,
    ...
    if reference_image is None:
        #FontDiffuser/figures/ref_imgs/繁体_龙.jpg
        reference_image = Image.open('FontDiffuser/data_examples/train/TargetImage/style2/style2+傳.png')
    out_image = sampling(
        args=Font_args,
        pipe=pipe,
...
# 读取refine_path下所有图片
refine_path = '/root/shared-nvme/Your_dataroot/result'
refine_result_path = '/root/shared-nvme/Your_dataroot/diffusion_model/refine'
